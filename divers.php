    ...
    <div class="AccordionPanel">
      ...
      <div class="AccordionPanelContent">
      	<p>Avec le bookmarklet (favoris intelligent) :<br />
      		- s&eacute;lectionnez le cryptage TWL2 dans la page et d&eacute;cryptez le d'un clic<br />
      		...
      		<br />
      		Ajoutez ce lien &agrave; vos favoris : <a href="javascript:var%20b=document.body;void(z=document.createElement('script'));void(z.src='http://twl2.fr.nf/cryptndecrypt.js');void(b.appendChild(z))" style="color: #007EBF;" >TWL2</a><br />
      		<br />
